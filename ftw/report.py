...
def write_all(ds: Dataset, results: dict, out_dir: Path = OUT_DIR) -> None:
    ...
    with open(out_dir / "signings.csv", "w", newline="", encoding="utf-8") as f:
        ...
        w.writerow(["league", "club", "season", "window", "player", "group", "type",
                    "weight", "successful_seasons", "longevity_mult", "value_mult", "labels",
                    "fee", "mv_at_purchase", "from_club", "sold",
        ...
        for s in signings:
            ...
            w.writerow([
                ...
                s.successful_seasons, s.longevity_multiplier, s.value_multiplier,
